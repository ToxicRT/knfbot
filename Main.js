...
client.on('ready', () => {
client.user.setActivity(`kn!help | kn!settings | Ahora el bot esta en Español !!! | ${client.guilds.size} Servidores`, 
  { 
       type: "STREAMING", 
